def NEAR_regex(list_of_words,max_words_between=5,partial=False,cases_matter=False,override_length=False):
    '''
    Parameters
    ----------
    list_of_words : list
    ...
    '''
    assert(override_length or (not override_length and len(list_of_words) < 4))
